                ...
                if(!group_Members.includes(uid)) {
                    ...
                    if(group_Images != undefined && group_Images != null) {
                        ...
                        database.ref("groups/" + gid + "/images/").once("value", function(snapshot) {
                            ...
                            var new_html = '<div id="loading"><div id="uploading-Img-Container"><img id="uploading-Img" src=""></div><div id="photo-Uploading-Text"><span>Uploading Image</span><div id="loading-Bar-Container"><div id="loading-Bar"></div></div><div></div>'                            
